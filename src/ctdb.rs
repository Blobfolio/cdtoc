...
impl Toc {
	...
	#[cfg_attr(feature = "docsrs", doc(cfg(feature = "ctdb")))]
	#[must_use]
	/// # CUETools Database Table of Contents.
	///
	/// This returns a table-of-contents string that can be used for CTDB
	/// checksum lookups.
	///
	/// ## Examples
	///
	...
	pub fn ctdb_toc(&self) -> String {
		...
		if matches!(self.kind, TocKind::DataFirst) {
			toc.push('-');
			toc.push_str(buf.format(self.data - 150));
			toc.push(':');
		}

		// Each audio track relative to the first.
		for v in &self.audio {
			toc.push_str(buf.format(v - 150));
			toc.push(':');
		}
		...
		// And the leadout.
		toc.push_str(buf.format(self.leadout - 150));
	...
	fn t_ctdb() {
		for (t, id, lookup) in [
			(
				...
				"32:15437:31705:45607:58345:70022:88015:95562:110147:123075:133987:144742:153945:164312:170700:191697:200987:211157:223797:233685:244447:251252:264720:270952:-297682:320565",
			),
			(
				"D+96+3B5D+78E3+B441+EC83+134F4+17225+1A801+1EA5C+23B5B+27CEF+2B58B+2F974+35D56+514C8",
				"gmEsiU5wvQFA1Nq9YE_posiwgK8-",
				"0:15047:30797:45995:60397:78942:94607:108395:125382:146117:162905:177397:194782:-220352:332850",
			),
			(
			...
			(
				...
				"32:21180:25110:39232:57730:76330:79185:82515:96282:105612:110650:124772:141292:149317:159710:172327:180325",
			),
			(
				...
				"9192:11094:19038:29394:38510:46846:57819:69690:76516:83243:93209:103737:111481:126900:135914:144791:153607:161959:173770:186780:196683:207536",
			),
			(
